                    ...
                    <div class="media">
                        ...
                        <div class="media-body" style="padding-top:5px; ">
                            ...
                            <?php foreach($model->tags as $tag) { ?>
                                <span class="label label-default"><a href="<?php echo Url::createUrl('question/tag', ['id' => $tag['tag_id']]); ?>"><?php echo \humhub\modules\questionanswer\models\Tag::findOne(['id' => $tag['tag_id'])->tag; ?></a></span>
                            <?php } ?>
                            <br /><br />
                            <?php
